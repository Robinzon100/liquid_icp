...
const Hero = () => {
    ...
    const init = () => {
        ...
        //============================ LIGHT
        const light = new THREE.DirectionalLight(0x1253FE, 100);
        light.position.set(0, 1, 0); //default; light shining from top
        light.castShadow = true; // default false
        scene.add(light);


        let pointLigtht1 = new THREE.PointLight(0xE05289, 60);
        pointLigtht1.position.set(10, 10, 10);
        scene.add(pointLigtht1)

        let pointLigtht2 = new THREE.PointLight(0x3357FA, 30);
        pointLigtht2.position.set(-10, 5, 0);
        scene.add(pointLigtht2)

        let pointLigtht3 = new THREE.PointLight(0x3357FA, 30);
        ...
        new RGBELoader().setPath("/hdr_textures/").load("syferfontein_0d_clear_2k.hdr", (hdrmap: any) => {
